package com.itobuz.android.awesomechat.database;
    ...
    public static  <T> Func1<Throwable, DatabaseResult<T>> errorAsDatabaseResult() {
        return new Func1<Throwable, DatabaseResult<T>>() {
            ...
            public DatabaseResult<T> call(Throwable throwable) {
                return (com.itobuz.android.awesomechat.database.DatabaseResult<T>) new DatabaseResult<>(throwable == null ? new Throwable("Database error is missing") : throwable);
            }
        };
    }

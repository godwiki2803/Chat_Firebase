package com.itobuz.android.awesomechat.conversation_list.presenter;
...
public class ConversationListPresenter {
    ...
    public void startPresenting() {
        ...
        final Subscriber<com.itobuz.android.awesomechat.user.data_model.User> userSubscriber = new Subscriber<User>() {
            @Override

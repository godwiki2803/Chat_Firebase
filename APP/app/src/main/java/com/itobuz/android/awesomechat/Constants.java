...
/**
 * Created by Debasis on 26/12/16.
 */
...
public class Constants {
    ...
    public static final String FIREBASE_USERS_PLACENAME = "placeName";
    public static final String FIREBASE_USERS_PLACELAT = "placeLat";
    public static final String FIREBASE_USERS_PLACELONG = "placeLong";
    ...
    public static final String FIREBASE_CHAT_ENABLED = "enabled";
    public static final String FIREBASE_CHAT_UNREADCOUNT = "unreadCount";

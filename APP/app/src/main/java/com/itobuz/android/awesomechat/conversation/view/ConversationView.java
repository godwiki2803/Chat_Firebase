...
import com.itobuz.android.awesomechat.Utils;
...
//        sendImageButton = (ImageButton) this.findViewById(R.id.imageiconButton);
...
//        sendImageButton.setOnClickListener(submitImageListener);
    }
...
//        sendImageButton.setOnClickListener(null);
    }
...
//    private final OnClickListener submitImageListener = new OnClickListener() {
//        @Override
//        public void onClick(View view) {
//            Log.i("OnclickListener: ", " ImageSend");
//        }
//    };
    ...
    private final PopupWindow.OnDismissListener emojiDismissListener = new PopupWindow.OnDismissListener() {
        ...
        public void onDismiss() {
            changeEmojiKeyboardIcon(emojiconButton, R.drawable.ic_menu_smiling);
        }
    };
